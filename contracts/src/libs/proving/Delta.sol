...
library Delta {
    ...
    function zero() internal pure returns (Types.Delta memory zeroDelta) {
        zeroDelta = Types.Delta({x: 0, y: 0});
    }
    ...
    function add(Types.Delta memory lhs, Types.Delta memory rhs) internal pure returns (Types.Delta memory sum) {
    ...
    function toAccount(Types.Delta memory delta) internal pure returns (address account) {
    ...
    function verify(bytes memory proof, Types.Delta memory instance, bytes32 verifyingKey) internal pure {
