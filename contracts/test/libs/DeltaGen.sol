...
library DeltaGen {
    ...
    function generateInstance(VmSafe vm, InstanceInputs memory inputs) internal returns (Types.Delta memory instance) {
    ...
    /// @return instance The mocked curve point.
    function generateInstanceFromPreDelta(VmSafe vm, uint256 preDelta) internal returns (Types.Delta memory instance) {
        ...
        instance = Types.Delta({x: wallet.publicKeyX, y: wallet.publicKeyY});
    }
